...
<div class="modal-body">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-3">
      <label for="tipo_negocio_id" class="col-form-label">Tipo de negocio</label>
    ...
    <input class="form-check-input" type="checkbox" value=" "name={{$tipo_comida->id}} class="form-check-input" id="exampleCheck1">
